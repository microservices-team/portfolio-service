...
class PortfolioServiceTest {
    ...
    void getAllExperiences_ReturnsActiveOnly() {
        ...
        List<ExperienceResponse> result = portfolioService.getAllExperiences();
    ...
    void getAllSkills_ReturnsAllSkills() {
        ...
        List<SkillResponse> result = portfolioService.getAllSkills();
    ...
    void getAllProjects_ReturnsActiveOnly() {
        ...
        List<ProjectResponse> result = portfolioService.getAllProjects();
    ...
    void getAllCertifications_ReturnsAll() {
        ...
        List<CertificationResponse> result = portfolioService.getAllCertifications();
